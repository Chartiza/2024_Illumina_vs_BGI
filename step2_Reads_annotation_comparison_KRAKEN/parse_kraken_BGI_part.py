...
dir_path = '/gpfs/space/home/pantiukh/2023_Illumina_vs_BGI/Kraken/kraken_BGI'  # current directory
filenames = [f for f in os.listdir(dir_path) if f.startswith('bgi')]
...
merged_df.to_csv('BGI_merged_output_part.csv', index=False) 
